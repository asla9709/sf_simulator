...
class Character extends InteractableObject {
    constructor(geometry, materials, name, dialogueBlocks) {
    ...
    showDialogue() {
        if (this.dialogueBlocks.length > 0) {
            ...
            // Toggle between materials 0 and 1
            this.talkingMaterialIndex = (this.talkingMaterialIndex + 1) % 2;
        }
    }
...
class InteractionManager {
    ...
    createTooltipSprite() {
        ...
        const texture = textureLoader.load('tooltip.png');
